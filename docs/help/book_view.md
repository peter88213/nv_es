[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../) > [${Online help}](./) > ${Book} properties
...
**Otros**, you see the three text boxes whose names you enter here.
