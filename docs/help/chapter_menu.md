[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../) > [${Online help}](./) > Capítulo menu
...
With **Capítulo > ${Add Chapter}**, you can add a chapter to the tree.
...
With **Capítulo > ${Add Part}**, you can add a part to the tree.
...
With **Capítulo > ${Add multiple chapters...}**, you can add up to 20
...
With **Capítulo > ${Set Type}**, you can set the
...
With **Capítulo > ${Change Level}**, you can turn chapters into parts and
vice versa.
...
With **Capítulo > ${Move selected chapters to new project}** you can create
...
With **Capítulo > ${Export chapter descriptions for editing}**, you can
...
With **Capítulo > ${Export part descriptions for editing}**, you can create a
...
With **Capítulo > ${Export chapter table}**, you can create a spreadsheet
...
With **Capítulo > ${Export part table}**, you can create a spreadsheet that
...
With **Capítulo > ${Show chapter structure board in browser}**, You can create a HTML file
