[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [xxx pages](../) > [${Help}](./) > ${Help} menu
...
With **${Help} > ${User guide}** you can launch your system web
browser with the *novelibre* user guide URL.
