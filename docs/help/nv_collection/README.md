[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../../) > [${Online help}](../) > nv_collection
...
You can open it with **Ayuda > ${Collection plugin Online help}**.
...
Open the collection manager from the main menu: **Archivo > ${Collection}**.
...
With **Archivo > Nuevo**, you can create a new collection. This will close
...
With **${Series} > Añadir**, you can add a new series. Edit the series' title
