[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../../) > [${Online help}](../) > nv_editor
...
open it with **Ayuda > ${Editor plugin Online help}**.
...
With **Archivo > ${Split at cursor position}** or `${Ctrl}`-`Alt`-`S`, you can
...
With **Archivo > ${Create section}** or `${Ctrl}`-`Alt`-`N`, you can create a section.
...
-   To close the editor window, click on the **Cerrar** button, or just close the window.
-   Under Windows you can optionally exit with **Sección > Salir** or `Alt`-`F4`.
-   Otherwise you can optionally exit with **Sección > ${Quit}** or `${Ctrl}`-`Q`.
