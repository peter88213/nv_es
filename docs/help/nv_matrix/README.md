[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../../) > [${Online help}](../) > nv_matrix
...
open it with **Ayuda > ${Matrix plugin Online help}**.

The plugin adds a **Matrix** entry to the *novelibre* **Herramientas** menu,
and a **${Matrix plugin Online help}** entry to the **Ayuda** menu. The
