[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [xxx pages](../../) > [${Help}](../) > nv_matrix
...
open it with **${Help} > ${Matrix plugin help}**
or `F1` when the matrix manager is active.
