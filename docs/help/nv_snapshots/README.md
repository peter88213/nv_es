[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../../) > [${Online help}](../) > nv_snapshots
...
can open it with **Ayuda > ${Snapshots plugin Online help}** or `F1`.

The plugin adds a **Snapshots** entry to the *novelibre* **Herramientas** menu,
a **Snapshot** entry to the **File** menu, and a 
**Snapshots Online help** entry to the **Ayuda** menu.
...
**Archivo > ${Snapshot}** menu command.

Use the **Herramientas > ${Snapshots}** menu command to start the 
...
3.  Select **${Edit} > ${Compare Document}** (OpenOffice), or
    *Archivo > ${Compare Document}** (newer versions of LibreOffice), or 
...
#### Ayuda > ${Snapshots plugin Online help}
