[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../../) > [${Online help}](../) > nv_themes
...
The plugin adds a **${Change theme}** entry to the *novelibre* **Ver** menu.
...
Start the theme changer from the main menu: **Ver > ${Change theme}**.
