[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../../) > [${Online help}](../) > nv_zim
...
with **Ayuda > ${Zim connection Online help}**.
...
**Herramientas** menu, and a **${Zim connection Online help}** entry to the
**Ayuda** menu. The property views of characters, locations, items, and
...
With **Herramientas > ${Zim Desktop Wiki} > ${Open project wiki}**, or clicking on
...
With **Herramientas > ${Zim Desktop Wiki} > ${Create project wiki}** you can create
...
With **Herramientas > ${Zim Desktop Wiki} > ${Remove wiki links}** you can remove
