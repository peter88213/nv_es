[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Spanish pages](../) > [${Online help}](./) > Argumento menu
...
With **Argumento > ${Add Plot line}**, you can add a plot line to the tree.
...
With **Argumento > ${Add Plot point}**, you can add a plot point to a plot line.
...
With **Argumento > ${Insert Stage}**, you can insert a stage after the selected
chapter or section.
...
With **Argumento > ${Change Level}**, you can change the level of the selected
stages.
...
With **Argumento > ${Import plot lines}**, you can import a selection of plot
...
With **Argumento > ${Export plot grid for editing}**, you can create a
...
With **Argumento > ${Export story structure description for editing}**, you can
...
With **Argumento > ${Export plot line descriptions for editing}**,
...
With **Argumento > ${Plot table (export only)}**, you can create a spreadsheet
...
With **Argumento > ${Show Plot table in browser}**, You can create a HTML file
