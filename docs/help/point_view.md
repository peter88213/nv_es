[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../) > [${Online help}](./) > ${Plot point} properties
...
"Sección" displays the section title.
...
-   **${Previous}** lets you navigate to the previous plot point in the
    tree.
-   **Siguiente** lets you navigate to the next plot point in the tree.
