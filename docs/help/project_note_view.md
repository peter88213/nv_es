[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../) > [${Online help}](./) > ${Project note} properties
...
-   **${Previous}** lets you navigate to the previous project note in the
    tree.
-   **Siguiente** lets you navigate to the next project note in the tree.
