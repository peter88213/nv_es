[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Páginas en castellano](../) > [${Online help}](./) > Herramientas menu
...
> **Note**
> 
> The *Herramientas* menu can be extended by plugins to add more features.
...
With **Herramientas > ${Backup options}**, you can open a dialog for settings
...
With **Herramientas > ${Open installation folder}**, you can launch the file
...
With **Herramientas > ${Plugin Manager}**, you can open the 
...
With **Herramientas > ${Show notes}**, you can create a HTML file that contains
