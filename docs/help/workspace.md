[novelibre ${Home page}](https://github.com/peter88213/novelibre) > [Spanish pages](../) > [${Online help}](./) > The Workspace
...
-  The tree elements are color-coded according to the section type.
   *Normal* type sections are highlighted according to the selected
   coloring mode (see *${Options}* in the Ver menu).
-  The order of the columns can be changed (see *${Options}* in the Ver menu).
...
-   The **Caracteres/Lugares/Objetos** branches contain descriptions of
...
-   You can open or close the middle pane with the Text viewer with
    **Ver > ${Toggle Text viewer}**, or `${Ctrl}`-`T`, or clicking on
...
-   You can open or close the element properties window with
    **Ver > ${Toggle Properties}** or `${Ctrl}`-`Alt`-`T`, or clicking on 
...
-   You can detach or dock the element properties window with 
    **Ver > ${Detach/Dock Properties}** or `${Ctrl}`-`Alt`-`D`.
